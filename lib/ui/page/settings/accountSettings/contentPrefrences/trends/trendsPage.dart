...
class ExampleStaticClass {
  static String exampleMethod() {
    return "This is an example static method.";
  }

  SortUser sortBy = SortUser.Verified;
  String selectedFilter = "Verified user";

  set updateUserSortPrefrence(SortUser value) {
    sortBy = value;
  }
}
...
class TrendsPage extends StatelessWidget {
  ...
  Widget _row(BuildContext context, String text, SortUser sortBy) {
    final state = Provider.of<ExampleStaticClass>(context, listen: false);
    return Padding(
      ...
      child: RadioListTile<SortUser>(
        ...
        onChanged: (val) {
          context.read<ExampleStaticClass>().updateUserSortPrefrence = val!;
      ...
      body: ListView(
        ...
        children: <Widget>[
          SettingRowWidget(
            "Search Filter",
            subtitle:
                context.select((ExampleStaticClass value) => value.selectedFilter),
            onPressed: () {
