...
import 'package:therapistapp/ui/page/common/usersListPage.dart';
import 'package:therapistapp/ui/page/profile/follow/followListState.dart';
...
class FollowerListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return UsersListPage(
      ...
      isFollowing: (user) {
        return context.watch<FollowListState>().isFollowingUser(user);
      },
