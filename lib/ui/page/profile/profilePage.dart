...
import 'package:therapistapp/ui/page/profile/follow/followingListPage.dart';
import 'package:therapistapp/ui/page/profile/profileImageView.dart';
import 'package:therapistapp/ui/page/profile/qrCode/scanner.dart';
import 'package:therapistapp/ui/page/profile/widgets/circular_image.dart';
import 'package:therapistapp/ui/page/profile/widgets/tabPainter.dart';
import 'package:therapistapp/ui/theme/theme.dart';
import 'package:therapistapp/widgets/cache_image.dart';
...
import 'package:therapistapp/helper/social_meta_tag_parameters.dart';

class ExampleProfileState extends ChangeNotifier {
  final String profileId;
  bool isMyProfile = false;
  bool isbusy = false;
  UserModel profileUserModel = UserModel();
  String userId = '';

  ExampleProfileState(this.profileId);

  void followUser({bool removeFollower = false}) {
    // Implement follow user logic
  }

  void setChatUser(UserModel user) {
    // Implement set chat user logic
  }
}
...
class ProfilePage extends StatefulWidget {
  ...
  static MaterialPageRoute getRoute({required String profileId}) {
    return MaterialPageRoute(
      builder: (_) => Provider(
        create: (_) => ExampleProfileState(profileId),
        child: ChangeNotifierProvider<ExampleProfileState>(
          create: (BuildContext context) => ExampleProfileState(profileId),
...
class _ProfilePageState extends State<ProfilePage>
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      var authState = Provider.of<ExampleProfileState>(context, listen: false);
  ...
  SliverAppBar getAppbar() {
    var authState = Provider.of<ExampleProfileState>(context);
    return SliverAppBar(
      forceElevated: false,
      expandedHeight: 200,
      elevation: 0,
  ...
  void shareProfile(BuildContext context) async {
    var authState = context.read<ExampleProfileState>();
          ...
          child: Row(
            children: <Widget>[
              ...
              _textButton(context, user.getFollower, ' Followers', () {
                var state = context.read<ExampleProfileState>();
                Navigator.push(
                  context,
