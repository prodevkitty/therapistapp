...
import 'package:therapistapp/ui/page/feed/composeTweet/widget/composeBottomIconWidget.dart';
import 'package:therapistapp/ui/page/feed/composeTweet/widget/composeTweetImage.dart';
import 'package:therapistapp/ui/page/feed/composeTweet/widget/widgetView.dart';
          ...
          Row(
            ...
            children: <Widget>[
              Padding(
                ...
                child:
                    CircularImage(path: authState.userModel?.profilePic, height: 40),
              ),
              Expanded(
                child: _TextField(
                  isTweet: false,
