...
class Utility {
  ...
  static void logEvent(String event, {Map<String, String>? parameter}) {
    if (kReleaseMode) {
      // Implement your own analytics logging here
      // For example, you can use another analytics service or your own backend
    } else {
      print("[EVENT]: $event");
    }
  }
  ...
  static Future<Uri> createLinkToShare(BuildContext context, String id,
    ...
    return Uri.parse("https://example.com/share?id=$id");
  }
